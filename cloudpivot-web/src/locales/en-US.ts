export default {
  ...
  login: {
    ...
    welcomeDesc: 'Sign in to your account',
    username: 'Username',
    password: 'Password',
    email: 'Email',
    captcha: 'Captcha',
    ...
    featureSecure: 'Secure SSH bastion access',
    featureControl: 'Fine-grained access control',
    featureAudit: 'Comprehensive session auditing',
  },
  dashboard: {
    title: 'Dashboard',
  ...
  monitor: {
    ...
    memoryPercent: 'Mem%',
    diskPercent: 'Disk%',
    networkInKbps: 'Net In(KB/s)',
    networkOutKbps: 'Net Out(KB/s)',
    load1: 'Load1',
  ...
  settings: {
    ...
    allowRegisterTip: 'When disabled, new users cannot register via the registration page',
  ...
  sftp: {
    ...
    selectHostTip: 'Please select a host to browse files',
    upload: 'Upload',
    ...
    paste: 'Paste',
    clipboard: 'Clipboard',
    cutTip: 'Cut to clipboard, navigate to target and paste',
    copyTip: 'Copied to clipboard, navigate to target and paste',
